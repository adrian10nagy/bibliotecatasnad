<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Admin._Default" %>
...
<%--            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i>From last Week</span>--%>
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i>Cărți împrumutate săptămâna curentă</span>
            <asp:Label ID="txtTotalLoansWeek" class="count" runat="server" ></asp:Label>
